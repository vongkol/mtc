        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-bold">
                    <i class="fa fa-align-justify"></i> Edit Cooperated Company&nbsp;&nbsp;
                ...
                <div class="card-block">
                    ...
                    <form action="{{url('/com/update')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-sm-8">
                                <input type="text" required autofocus name="employer_id" id="employer_id" class="form-control" value="{{$company->employer_id}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-sm-8">
                                <input type="text" required name="name" id="name" class="form-control" value="{{$company->name}}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-sm-8">
                                ...
                                <img src="{{asset('company/'.$company->logo)}}" alt="" id="img" width="150">
                            </div>
                        </div>
                        <div class="form-group row">
