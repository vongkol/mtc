            ...
            <div class="card-group mb-0">
                <div class="card p-4">
                    <div class="card-block">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="email" name="email" autofocus required value="{{ old('email') }}" class="form-control" placeholder="Email">
                ...
                <div class="card card-inverse card-primary py-5 d-md-down-none" style="width:44%">
                    <div class="card-block text-center">
                        <div>
                            <h2>Master Jobs Cambodia</h2>
                            <p>Recruitment, training center of people who want to get a good job</p>
