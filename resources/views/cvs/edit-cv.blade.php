        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-bold">
                    <i class="fa fa-align-justify"></i> Edit CV&nbsp;&nbsp;
                ...
                <div class="card-block">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="dob" id="dob" value="{{$employee->dob}}" placeholder="dd/mm/yyyy">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="pob" class="control-label col-sm-3" style="text-align: left;">Place of Birth</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="pob" id="pob" value="{{$cv->pob}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        @foreach($nationalities as $n)
                                            <option value="{{$n->name}}" {{$cv->nationality==$n->name?'selected':''}}>{{$n->name}}</option>
                                        @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="phone" id="phone" placeholder="086 397 627" value="{{$employee->phone}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control" name="password" id="password" placeholder="Default password is first name!">
                                    </div>
                                </div>
                                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12 col-sm-12">
                            <button class="btn btn-primary border-radius-none" type="button" id="btnSave">Save Changes</button>
