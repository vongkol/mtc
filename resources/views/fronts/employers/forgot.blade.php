...
<div class="row">
    <div class="col-md-9">
        <div class="col-md-7 offset-md-3">
            <h3 class="page-title" style="background: #FFECB3;">{{trans('labels.recovery_password')}}</h3>
            <div class="border">
                        <form action="{{url('/employer/forgot/recovery')}}" class="form-horizontal" method="post">
                            @if(Session::has('sms'))
                                <div class="row">
                                    <div class="col-sm-12">
