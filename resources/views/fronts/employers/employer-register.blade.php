...
<div class="row">
    ...
    <div class="col-md-7 offset-md-3">
        <h3 class="page-title" style="background: #FFECB3;">{{trans("labels.seeker_registration_form")}}</h3>
        <div class="border">
            <form action="{{url('/employer/save')}}"  id="register" method="post" accept-charset="UTF-8" role="form" onsubmit="check(event)">
                {{csrf_field()}}
                @if(Session::has('sms1'))
                <div class="row">
                    <div class="col-sm-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <button class="btn btn-warning" type="submit">{{trans("labels.register")}}</button>
