...
@section('content')
    <div class="page-title" style="background: #FFECB3;">
        {{trans('labels.reset_my_password')}}
    </div>
    <div class="border">
            @if(Session::has('sms'))
                <div class="row">
            ...
            @endif
            <form action="{{url('/employer/save-password')}}" class="form-horizontal" method="post" accept-charset="UTF-8" role="form" onsubmit="check(event)" >
