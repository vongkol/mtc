    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        ...
        <?php $logo = DB::table('logos')->first(); ?>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">{{trans("labels.employer")}}</a>
                </li>
                @if(Session::has('employer'))
                    ...
                    <a class="nav-link dropdown-toggle" href="{{url('seeker/profile')}}" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Hi, {{session('employer')->first_name}}</a>
                        ...
                        <a class="dropdown-item" href="{{url('/employer')}}">{{trans('labels.my_profile')}}</a>
                     
                        <a class="dropdown-item" href="{{url('/employer/subscription')}}">{{trans('labels.my_subscription')}}</a>
                   <a class="dropdown-item" href="{{url('/employer/job')}}">{{trans('labels.my_job')}}</a>
   
                   
                        <a class="dropdown-item" href="{{url('/employer/company')}}">{{trans('labels.my_company')}}</a>
                                     
                        <a class="dropdown-item" href="{{url('/employer/search/cv')}}">{{trans('labels.find_cv')}}</a>
       
                
                        <a class="dropdown-item" href="{{url('/employer/favorite')}}">{{trans('labels.favorite_cv')}}</a>
                  
                        <a class="dropdown-item" href="{{url('/employer/reset-password')}}">{{trans('labels.change_password')}}</a>

                        <a class="dropdown-item text-danger" href="{{url('/employer/logout')}}">{{trans('labels.logout')}}</a>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-12 col-12">
               <div class="page-title" style="background: #FFECB3;">
                        {{trans('labels.manage_account')}}
                        </div>
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer')}}">{{trans('labels.my_profile')}}</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer/subscription')}}">{{trans('labels.my_subscription')}}</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer/job')}}">{{trans('labels.my_job')}}</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer/company')}}">{{trans('labels.my_company')}}</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer/search/cv')}}">{{trans('labels.find_cv')}}</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer/favorite')}}">{{trans('labels.favorite_cv')}}</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer/reset-password')}}">{{trans('labels.change_password')}}</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer/logout')}}" class="text-danger">  {{trans('labels.logout')}}</a>
                            </li>
                        </ul>
                    </div>
